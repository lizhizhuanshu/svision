#ifndef SVISION_COLOR_H
#define SVISION_COLOR_H
#include"base.h"
#include<memory.h>
#include<string>

template<class String>
static int compareColor(const unsigned char* color,String* color1, const unsigned char* shift)
{
...
template<class String>
static int compareColor(const unsigned char* color, String* color1, int shift)
{
...
public:
    ...
    NotColor(const unsigned char* color)
            :mData(0)
    {
        memcpy(&mData, color, 3);
    }
    ...
    int operator == (const NotColor& other)
    {
        return mData == other.mData;
    }
...
class StringNotColor
{
    std::string mData;
public:
    StringNotColor(const char* str,size_t size)
            :mData(str,size)
    {}
    StringNotColor(std::string & color)
            :mData(color)
    {}
